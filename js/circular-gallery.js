...
async function loadOGL() {
  ...
  for (const source of sources) {
    try {
      ...
      if (!mod || !mod.Camera || !mod.Renderer) {
        continue;
      }
...
function createTextTexture(gl, text, font = 'bold 30px Arial', color = '#ffffff') {
  const canvas = document.createElement('canvas');
...
class Title {
  constructor({ gl, plane, renderer, text, textColor = '#ffffff', font = 'bold 30px Arial' }) {
    autoBind(this);
    this.gl = gl;
    this.plane = plane;
...
class App {
  constructor(container, { items, bend, textColor = '#ffffff', borderRadius = 0.05, font = 'bold 24px Arial', scrollSpeed = 2, scrollEase = 0.02, autoScrollSpeed = 0.03 } = {}) {
    autoBind(this);
  ...
  createMedias(items, bend = 3, textColor, borderRadius, font) {
    const defaultItems = [
      { image: 'img/IMG_7578.jpg', text: 'Coffee Moments' },
      { image: 'img/IMG_7581.jpg', text: 'Daily Moments' },
      { image: 'img/IMG_7582.jpg', text: 'Warm Corners' },
      { image: 'img/IMG_7598.JPG.jpg', text: 'Neighborhood Energy' },
      { image: 'img/IMG_7600.JPG.jpeg', text: 'Coffee Rituals' },
      { image: 'img/IMG_7603.JPG.jpeg', text: 'Fresh Brews' },
      { image: 'img/IMG_7604.JPG.jpeg', text: 'Meet and Connect' },
      { image: 'img/IMG_7781.jpg', text: 'Ocho Vibes' }
    ];
